...
def patch_record_in_place(fn, record, subdir):
    ...
    if name == "pytorch" and version in ["2.7.0", "2.8.0"]:
        # pytorch 2.7.0 and 2.8.0 used libtorch {{ version }} instead of
    ...
    # anaconda-cli-base 0.8.0 and 0.8.1 use a dump flag from pydantic that was introduced in version 2.12
    # https://github.com/anaconda/anaconda-cli-base/pull/133
    if name == 'anaconda-cli-base' and version in ['0.8.0', '0.8.1']:
        depends.append("pydantic >=2.12")
    ...
    if name == "transformers" and version == "4.14.1":
        replace_dep(depends, "huggingface_hub", "huggingface_hub >=0.1.0,<1.0")
    ...
    if name == "xgrammar" and (version == "0.2.2" or version == "0.2.3"):
        replace_dep(depends, ["apache-tvm-ffi >=0.1.9,<0.2.0a0", "apache-tvm-ffi >=0.1.9"], "apache-tvm-ffi ==0.1.9")
